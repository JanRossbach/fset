(ns fset.encoder.core
  (:require
   [clojure.walk :refer [postwalk]]
   [fset.dsl.interface :refer [MACHINE AND BOOLDEFS AND]]
   [fset.encoder.translations :refer [boolvars->set unroll-sub unroll-predicate]]
   [clojure.core.match :refer [match]]
   [taoensso.timbre :as log]
   [fset.simplifier.interface :refer [simplify-all]]
